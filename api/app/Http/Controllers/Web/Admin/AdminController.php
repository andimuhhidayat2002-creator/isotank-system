...
class AdminController extends Controller
{
    public function dashboard(Request $request)
    {
        ...
        $locations = MasterIsotank::select('location')
            ...
            ->selectRaw("count(*) - sum(case when filling_status_code LIKE 'filled%' then 1 else 0 end) as empty_count")
            ->selectRaw("sum(case when filling_status_code LIKE 'filled%' then 1 else 0 end) as filled_count")
            ...
            switch ($request->activity_type) {
                ...
                case 'maintenance':
                    MaintenanceJob::create([
                        ...
                        'part_damage' => $request->part_damage,
